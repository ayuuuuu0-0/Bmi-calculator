...
const kLargeButtonstyle = TextStyle(fontSize: 30.0, fontWeight: FontWeight.bold);
const kTitleTextStyle = TextStyle(fontSize: 50.0, fontWeight: FontWeight.bold);
const kResultTextStyle = TextStyle(color: Color(0xFF28EC45), fontSize: 30.0, fontWeight: FontWeight.bold);
